...
BUILD="$NNT/build"
SRC="$NNT/Applications/CausalLM/attn_ref/rope_default_partial_test.cpp"
OUT=/home/aisjetson/jijoongmoon/nntrainer-s/build/refbin/rope_default_partial
mkdir -p "$(dirname "$OUT")"

cd "$BUILD"

echo "[rope-dp] compiling..."
