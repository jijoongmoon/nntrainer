...
BUILD="$NNT/build"
SRC="$NNT/Applications/CausalLM/gdn_ref/gdn_p1_test.cpp"
OUT=/home/aisjetson/jijoongmoon/nntrainer-s/build/refbin/gdn_p1
mkdir -p "$(dirname "$OUT")"

cd "$BUILD"

echo "[gdn-p1] compiling..."
...
rc=0
echo "### case 1: B=1 S=8 (gdn_p0/bin)"
GDN_B=1 GDN_S=8 GDN_DIR=/home/aisjetson/jijoongmoon/gdn_p0/bin "$OUT" || rc=$?
echo "### case 2: B=2 S=20 (gdn_p0/bin_case2)"
GDN_B=2 GDN_S=20 GDN_DIR=/home/aisjetson/jijoongmoon/gdn_p0/bin_case2 "$OUT" || rc=$?
exit $rc
