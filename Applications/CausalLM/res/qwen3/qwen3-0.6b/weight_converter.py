...
## Transformer::createMlp in the C++ code. Both the symbolic API and
## the legacy string-based API in main use this same order, so a single
## .bin generated by this script loads on both branches with correct
## sequential weight offsets.
