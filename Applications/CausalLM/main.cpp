...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    // Deferring the render past repack_weight() hands it the same window an
    // embedding host already gets for free (create + initialize +
    // load_weight + repack), where the measured overlap is total.
    //
