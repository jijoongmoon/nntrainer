...
Lfm2CausalLM::Lfm2CausalLM() = default;
...
void Lfm2CausalLM::constructModel() {
  ...
  // Layer types: ['conv', 'conv', 'attention', 'conv', 'conv', 'attention', 'conv', 'conv', 'attention', 'conv', 'attention', 'conv', 'attention', 'conv', 'attention', 'conv', 'conv']
...
Tensor
Lfm2CausalLM::createConvDecoderBlock(const int layer_id,
  Tensor input) {
  ...
  // Conv operator (auto-generated)
  LayerHandle op_0(createLayer("fully_connected", {
  ...
  LayerHandle op_2(createLayer("fully_connected", {
    withKey("name", prefix + "_conv_out_proj"),
    withKey("unit", 1536),
    withKey("disable_bias", "true")
  }));
  Tensor op_2_out = op_2(op_1_out);

  // Conv residual connection
  Tensor residual = input.add(op_2_out);
...
Tensor
Lfm2CausalLM::createAttention(const int layer_id, int seq_len, int n_heads,
