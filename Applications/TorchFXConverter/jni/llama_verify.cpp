...
LlamaCausalLM::LlamaCausalLM() = default;

void LlamaCausalLM::constructModel() {
...
Tensor
LlamaCausalLM::createTransformerDecoderBlock(const int layer_id,
  Tensor input) {
...
Tensor
LlamaCausalLM::createAttention(const int layer_id, int seq_len, int n_heads,
...
Tensor LlamaCausalLM::createMlp(
...
void LlamaCausalLM::registerCustomLayers() {
