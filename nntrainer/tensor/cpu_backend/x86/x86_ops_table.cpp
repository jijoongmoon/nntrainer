 ...
 * @brief  x86 CPU backend ComputeOps subclass.
 *
 * Concrete ComputeOps subclass for x86 (AVX2/AVX-512) targets. Each
 * override forwards to the existing nntrainer::* implementation in
 * x86_compute_backend.cpp. CPU backends are stateless so this class
...
class X86ComputeOps : public ComputeOps {
public:
  // FP32 BLAS
