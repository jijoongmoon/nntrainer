 ...
 * @brief  x86-specific ComputeOps table. References functions defined in
 *         x86_compute_backend.cpp (same translation unit via x86_compute_backend.h).
...
// Forward declarations - these are defined in x86_compute_backend.cpp
// and x86_compute_backend_fp16.cpp within namespace nntrainer.
// By referencing them here, the linker binds to x86-specific implementations.
