 ...
 * @brief  Fallback CPU backend ComputeOps subclass.
 *
 * Concrete ComputeOps subclass for portable fallback targets. Each
 * override forwards to the existing nntrainer::* implementation in
 * fallback.cpp. CPU backends are stateless so this class
...
class FallbackComputeOps : public ComputeOps {
public:
  // FP32 BLAS
...
ComputeOps *get_fallback_ops() {
  static FallbackComputeOps instance;
  return &instance;
}
