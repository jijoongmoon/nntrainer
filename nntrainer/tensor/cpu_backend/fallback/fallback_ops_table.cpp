 ...
 * @brief  Fallback ComputeOps table. References functions defined in
 *         fallback.cpp (same translation unit via fallback.h).
...
// Forward declarations - these are defined in fallback.cpp
// and fallback_fp16.cpp within namespace nntrainer.
// By referencing them here, the linker binds to Fallback implementations.
