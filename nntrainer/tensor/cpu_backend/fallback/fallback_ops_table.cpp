 ...
 *
 * Each wrapper function adapts the fallback backend implementation to the
...
static ComputeOps fallback_ops = {
  ...
  .gelu_v2_fp32 = fallback_backend::gelu_v2_fp32,
  ...
  .quantize_q4_0 = fallback_backend::quantize_q4_0_impl,
  .dequantize_row_q4_0 = fallback_backend::dequantize_row_q4_0_impl,
  .repack_q4_0 = fallback_backend::repack_q4_0_impl,
  .clamp_fp32 = fallback_backend::clamp_fp32,
  .scopy_int8_to_fp32_u = fallback_backend::scopy_int8_to_fp32_u,
  .scopy_int8_to_fp32_s = fallback_backend::scopy_int8_to_fp32_s,
