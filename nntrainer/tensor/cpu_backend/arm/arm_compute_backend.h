...
// [merge 2026-06-30] nntr_gemm_qai8dxp_qsi4cxp_* per-channel int4 KAI template
// decls. Upstream's kleidiai refactor dropped these from this header; our facade
// keeps the nntr_*<T> API, and arm_compute_backend_fp16.cpp defines
// nntrainer::-scoped specializations, so re-declare them here.
