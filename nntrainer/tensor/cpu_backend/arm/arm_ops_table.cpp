 ...
 * @brief  ARM CPU backend ComputeOps table.
 *
...
static void saxpy_fp32(const unsigned int N, const float a, const float *X,
                       const unsigned int iX, float *Y, const unsigned int iY) {
...
static ComputeOps arm_ops = {
  .sgemm_fp32 = arm_backend::sgemm_fp32,
  .sgemv_fp32 = arm_backend::sgemv_fp32,
  .sdot_fp32 = arm_backend::sdot_fp32,
  .saxpy_fp32 = arm_backend::saxpy_fp32,
  .scopy_fp32 = arm_backend::scopy_fp32,
  .sscal_fp32 = arm_backend::sscal_fp32,
  .snrm2_fp32 = arm_backend::snrm2_fp32,
  .isamax_fp32 = arm_backend::isamax_fp32,
  .ele_mul_fp32 = arm_backend::ele_mul_fp32,
  .ele_add_fp32 = arm_backend::ele_add_fp32,
  .ele_sub_fp32 = arm_backend::ele_sub_fp32,
  .ele_div_fp32 = arm_backend::ele_div_fp32,
  .swiglu_fp32 = arm_backend::swiglu_fp32,
  .swiglu_alpha_fp32 = arm_backend::swiglu_alpha_fp32,
  .tanh_gelu_fp32 = arm_backend::tanh_gelu_fp32,
  .gelu_v2_fp32 = arm_backend::gelu_v2_fp32,
  .tanh_gelu_v2_fp32 = arm_backend::tanh_gelu_v2_fp32,
  .tanh_gelu_mul_fp32 = arm_backend::tanh_gelu_mul_fp32,
  .tanh_gelu_v2_mul_fp32 = arm_backend::tanh_gelu_v2_mul_fp32,
  .max_val_fp32 = arm_backend::max_val_fp32,
  .softmax_fp32 = arm_backend::softmax_fp32,
  .is_valid_fp32 = arm_backend::is_valid_fp32,
  .transpose_matrix_fp32 = arm_backend::transpose_matrix_fp32,
  ...
  .gemm_q4_0_fp32 = arm_backend::gemm_q4_0_fp32,
  .gemm_q4_K_fp32 = arm_backend::gemm_q4_K_fp32,
  ...
  .scopy_int8_to_float16_s =
    static_cast<void (*)(const unsigned int, const int8_t *, const unsigned int,
                         _FP16 *, const unsigned int)>(
      nntrainer::scopy_int8_to_float16),
