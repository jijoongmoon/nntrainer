...
// and non-finite value -- same verification as rms_h2f_hw below); the scalar
// rmsnorm_fp16 (prefill attention/ffn norms, q/k per-head norms) inherits it
// with no value or order change.
