...
# B0 PHWC4 layout round-trip test — uses raw cl_mem, no SVM, no Tensor plumbing.
LOCAL_MODULE := unittest_opencl_phwc4_layout
...
LOCAL_SRC_FILES := \
	 ../unittest/unittest_opencl_phwc4_layout.cpp
...
# B1 weight repack layout round-trip test.
LOCAL_MODULE := unittest_opencl_weight_pack_layout
LOCAL_CFLAGS := -Igoogletest/include -I../include -I../unittest/layers -I../../nntrainer/layers/loss -pthread -fexceptions -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=1 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti -DNDK_BUILD=1 -DENABLE_FP16=1 -DENABLE_OPENCL=1
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
LOCAL_LDLIBS        := -llog -landroid

LOCAL_SRC_FILES := \
	 ../unittest/unittest_opencl_weight_pack_layout.cpp
...
# B1-int4 per-channel int4 weight layout round-trip test.
LOCAL_MODULE := unittest_opencl_weight_pack_int4cxp_layout
LOCAL_CFLAGS := -Igoogletest/include -I../include -I../unittest/layers -I../../nntrainer/layers/loss -pthread -fexceptions -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=1 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti -DNDK_BUILD=1 -DENABLE_FP16=1 -DENABLE_OPENCL=1
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
LOCAL_LDLIBS        := -llog -landroid

LOCAL_SRC_FILES := \
	 ../unittest/unittest_opencl_weight_pack_int4cxp_layout.cpp
...
# B4 1x1 conv-as-matmul correctness test.
LOCAL_MODULE := unittest_opencl_conv_1x1_fp32
LOCAL_CFLAGS := -Igoogletest/include -I../include -I../unittest/layers -I../../nntrainer/layers/loss -pthread -fexceptions -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=1 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti -DNDK_BUILD=1 -DENABLE_FP16=1 -DENABLE_OPENCL=1
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
LOCAL_LDLIBS        := -llog -landroid

LOCAL_SRC_FILES := \
	 ../unittest/unittest_opencl_conv_1x1_fp32.cpp
...
# B5 per-token INT8 activation quantize roundtrip test.
LOCAL_MODULE := unittest_opencl_phwc4_int8_quant
LOCAL_CFLAGS := -Igoogletest/include -I../include -I../unittest/layers -I../../nntrainer/layers/loss -pthread -fexceptions -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=1 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti -DNDK_BUILD=1 -DENABLE_FP16=1 -DENABLE_OPENCL=1
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
LOCAL_LDLIBS        := -llog -landroid

LOCAL_SRC_FILES := \
	 ../unittest/unittest_opencl_phwc4_int8_quant.cpp
...
# Perf benchmark for RMSNorm + residual fused fp16 kernel.
LOCAL_MODULE := unittest_opencl_perf_rmsnorm_residual_fused
LOCAL_CFLAGS := -Igoogletest/include -I../include -I../unittest/layers -I../../nntrainer/layers/loss -pthread -fexceptions -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=1 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti -DNDK_BUILD=1 -DENABLE_FP16=1 -DENABLE_OPENCL=1
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
LOCAL_LDLIBS        := -llog -landroid

LOCAL_SRC_FILES := \
	 ../unittest/unittest_opencl_perf_rmsnorm_residual_fused.cpp
...
LOCAL_SRC_FILES := \
	 ../unittest/unittest_opencl_perf_conv_1x1_int4cxp_decode_fused.cpp
...
# Perf benchmark for tile-W4 with fp16 output.
LOCAL_MODULE := unittest_opencl_perf_conv_1x1_int4cxp_qai8_img2d_tile_w4_fp16o
LOCAL_CFLAGS := -Igoogletest/include -I../include -I../unittest/layers -I../../nntrainer/layers/loss -pthread -fexceptions -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=1 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti -DNDK_BUILD=1 -DENABLE_FP16=1 -DENABLE_OPENCL=1
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
LOCAL_LDLIBS        := -llog -landroid

LOCAL_SRC_FILES := \
	 ../unittest/unittest_opencl_perf_conv_1x1_int4cxp_qai8_img2d_tile_w4_fp16o.cpp
...
# Perf benchmark for Tier S2 tile-W4 variant (4 tokens per work-item).
LOCAL_MODULE := unittest_opencl_perf_conv_1x1_int4cxp_qai8_img2d_tile_w4
LOCAL_CFLAGS := -Igoogletest/include -I../include -I../unittest/layers -I../../nntrainer/layers/loss -pthread -fexceptions -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=1 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti -DNDK_BUILD=1 -DENABLE_FP16=1 -DENABLE_OPENCL=1
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
LOCAL_LDLIBS        := -llog -landroid

LOCAL_SRC_FILES := \
	 ../unittest/unittest_opencl_perf_conv_1x1_int4cxp_qai8_img2d_tile_w4.cpp
...
# Perf benchmark for B2 image2d-weight variant (event-profiling).
LOCAL_MODULE := unittest_opencl_perf_conv_1x1_int4cxp_qai8_img2d
LOCAL_CFLAGS := -Igoogletest/include -I../include -I../unittest/layers -I../../nntrainer/layers/loss -pthread -fexceptions -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=1 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti -DNDK_BUILD=1 -DENABLE_FP16=1 -DENABLE_OPENCL=1
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
LOCAL_LDLIBS        := -llog -landroid

LOCAL_SRC_FILES := \
	 ../unittest/unittest_opencl_perf_conv_1x1_int4cxp_qai8_img2d.cpp
...
# Perf benchmark for B4-int4-int8 (event-profiling, kernel-only timing).
LOCAL_MODULE := unittest_opencl_perf_conv_1x1_int4cxp_qai8
LOCAL_CFLAGS := -Igoogletest/include -I../include -I../unittest/layers -I../../nntrainer/layers/loss -pthread -fexceptions -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=1 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti -DNDK_BUILD=1 -DENABLE_FP16=1 -DENABLE_OPENCL=1
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
LOCAL_LDLIBS        := -llog -landroid

LOCAL_SRC_FILES := \
	 ../unittest/unittest_opencl_perf_conv_1x1_int4cxp_qai8.cpp
...
# B4-int4-int8 1x1 conv-as-matmul (int4 weight × int8 activation) test.
LOCAL_MODULE := unittest_opencl_conv_1x1_int4cxp_qai8
LOCAL_CFLAGS := -Igoogletest/include -I../include -I../unittest/layers -I../../nntrainer/layers/loss -pthread -fexceptions -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=1 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti -DNDK_BUILD=1 -DENABLE_FP16=1 -DENABLE_OPENCL=1
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
LOCAL_LDLIBS        := -llog -landroid

LOCAL_SRC_FILES := \
	 ../unittest/unittest_opencl_conv_1x1_int4cxp_qai8.cpp
...
# B4-int4 1x1 conv-as-matmul correctness test (int4 weight + fp32 activation).
LOCAL_MODULE := unittest_opencl_conv_1x1_int4cxp_fp32
LOCAL_CFLAGS := -Igoogletest/include -I../include -I../unittest/layers -I../../nntrainer/layers/loss -pthread -fexceptions -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=1 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti -DNDK_BUILD=1 -DENABLE_FP16=1 -DENABLE_OPENCL=1
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
LOCAL_LDLIBS        := -llog -landroid

LOCAL_SRC_FILES := \
	 ../unittest/unittest_opencl_conv_1x1_int4cxp_fp32.cpp
...
LOCAL_CFLAGS := -Igoogletest/include -I../include -I../unittest/layers -I../../nntrainer/layers/loss -pthread -fexceptions -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=1 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti -DNDK_BUILD=1 -DENABLE_FP16=1 -DENABLE_OPENCL=1 -DUSE__FP16=1
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
LOCAL_LDLIBS        := -llog -landroid
...
LOCAL_MODULE := unittest_neon_gelu
LOCAL_CFLAGS := -Igoogletest/include -I../include -I../unittest/layers -I../../nntrainer/layers/loss -pthread -fexceptions -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=1 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti -DNDK_BUILD=1 
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
LOCAL_LDLIBS        := -llog -landroid

LOCAL_SRC_FILES := \
	 ../unittest/unittest_neon_gelu.cpp
...
LOCAL_MODULE := unittest_thread_manager
LOCAL_CFLAGS := -Igoogletest/include -I../include -pthread -fexceptions -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=4 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti -DNDK_BUILD=1 -DENABLE_FP16=1 -DUSE__FP16=1
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
LOCAL_LDLIBS        := -llog -landroid

LOCAL_SRC_FILES := \
	 ../unittest/unittest_thread_manager.cpp
...
LOCAL_CFLAGS := -Igoogletest/include -I../include -pthread -fexceptions -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=1 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
LOCAL_LDLIBS        := -llog -landroid
