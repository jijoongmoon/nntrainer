...
TEST(nntrainer_capi_nnmodel, train_with_generator_01_p) {
  ...
  status = ml_nnmodel_train_with_generator(
    model, NULL, NULL, NULL, "epochs=1", "batch_size=16",
    "train_data=trainingSet.dat", "val_data=valSet.dat", "label_data=label.dat",
    "buffer_size=100", "model_file=model.bin", NULL);
