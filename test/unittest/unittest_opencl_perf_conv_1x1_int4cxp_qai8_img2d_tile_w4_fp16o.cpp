 ...
 *
 * @file    unittest_opencl_perf_conv_1x1_int4cxp_qai8_img2d_tile_w4_fp16o.cpp
 * @date    15 May 2026
...
namespace nntrainer {
extern const std::string conv_1x1_int4cxp_qai8_img2d_w_tile_w4_fp16o_kernel;
}
...
static PerfStats bench_tile_w4_fp16o(int B, int C_in, int C_out, int H, int W,
  ...
  const char *src =
    nntrainer::conv_1x1_int4cxp_qai8_img2d_w_tile_w4_fp16o_kernel.c_str();
  const size_t src_len =
    nntrainer::conv_1x1_int4cxp_qai8_img2d_w_tile_w4_fp16o_kernel.size();
  ...
  cl_kernel kern =
    clCreateKernel(prog, "conv_1x1_int4cxp_qai8_img2d_w_tile_w4_fp16o", &err);
  EXPECT_EQ(err, CL_SUCCESS);
  ...
  EXPECT_EQ(err, CL_SUCCESS);
  // fp16 output: 2 bytes per element, not 4.
  cl_mem d_y = clCreateBuffer(ctx, CL_MEM_WRITE_ONLY,
                              y_elems * sizeof(std::uint16_t), nullptr, &err);
  EXPECT_EQ(err, CL_SUCCESS);
...
TEST(perf_conv_1x1_int4_qai8_img2d_tile_w4_fp16o, small_baseline) {
  auto s = bench_tile_w4_fp16o(1, 1024, 1024, 1, 64, 3, 10);
  report("conv_1x1_int4cxp_qai8_img2d_w_tile_w4_fp16o", 1, 1024, 1024, 1, 64, s);
...
TEST(perf_conv_1x1_int4_qai8_img2d_tile_w4_fp16o, prefill_seq128_hidden_4k) {
  auto s = bench_tile_w4_fp16o(1, 4096, 4096, 1, 128, 3, 10);
  report("conv_1x1_int4cxp_qai8_img2d_w_tile_w4_fp16o", 1, 4096, 4096, 1, 128, s);
  EXPECT_GT(s.median_us, 0.0);
}

TEST(perf_conv_1x1_int4_qai8_img2d_tile_w4_fp16o, llama_ffn_up_proj_seq128) {
  auto s = bench_tile_w4_fp16o(1, 4096, 11008, 1, 128, 3, 5);
  report("conv_1x1_int4cxp_qai8_img2d_w_tile_w4_fp16o", 1, 4096, 11008, 1, 128, s);
  EXPECT_GT(s.median_us, 0.0);
}

TEST(perf_conv_1x1_int4_qai8_img2d_tile_w4_fp16o, llama_ffn_down_proj_seq128) {
  auto s = bench_tile_w4_fp16o(1, 11008, 4096, 1, 128, 3, 5);
  report("conv_1x1_int4cxp_qai8_img2d_w_tile_w4_fp16o", 1, 11008, 4096, 1, 128, s);
  EXPECT_GT(s.median_us, 0.0);
}
