...
int main() {
  ...
  // Qwen3-0.6B: hidden=896, heads_Q=14, heads_KV=2, dim=64
  std::cout << "--- Qwen3-0.6B ---\n";
  run_attention_comparison({896, 14, 2, 64, 28, 32, 16});

  // Qwen3-1.7B: hidden=1536, heads_Q=12, heads_KV=4, dim=128
  std::cout << "--- Qwen3-1.7B ---\n";
  run_attention_comparison({1536, 12, 4, 128, 28, 32, 16});

  // Qwen3-4B: hidden=2560, heads_Q=32, heads_KV=4, dim=128
  std::cout << "--- Qwen3-4B ---\n";
  run_attention_comparison({2560, 32, 4, 128, 40, 16, 8});
